...
<head>
    ...
    <title>{{ $property->title ?? 'Propiedad de lujo' }} | CTP Realty</title>
...
<body>
    ...
    @php
        // Simulación de imágenes para demostración (en producción usar $property->images)
        $demoImages = [
        ...
        $properties = (object) [
            'images' => collect($demoImages)->map(fn($url, $i) => (object) ['url' => $url]),
            'title' => 'Casa de lujo en Puerta de Hierro',
            'video_url' => null,
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-brand">
                <img src="{{ asset('Logo.png') }}" alt="CTP Realty" style="height:55px;">
                <p>CTP Realty es una empresa líder en bienes raíces y construcción en Guadalajara, comprometida con la
                    excelencia desde 2009.</p>
            </div>
        ...
        <div class="footer-bottom">
            <p>&copy; 2024 CTP Realty. Todos los derechos reservados.</p>
        </div>
    </footer>
